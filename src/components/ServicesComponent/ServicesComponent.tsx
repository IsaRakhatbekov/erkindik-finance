        ...
        <ul className={styles.list}>
          <li className={styles.item}>
            <div className={styles.imgWrapper}>
              <Image src={Services1} alt="design icon" loading="lazy" />
            </div>
          ...
          <li className={styles.item}>
            <div className={styles.imgWrapper}>
              <Image src={Services2} alt="design icon" loading="lazy" />
            </div>
          ...
          <li className={styles.item}>
            <div className={styles.imgWrapper}>
              <Image src={Services3} alt="design icon" loading="lazy" />
            </div>
          ...
          <li className={styles.item}>
            <div className={styles.imgWrapper}>
              <Image src={Services4} alt="design icon" loading="lazy" />
            </div>
